...
func (c *CPU) xori(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20
...
func (c *CPU) ori(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20
	c.X[rd] = c.X[rs1] | uint32(imm)
...
func (c *CPU) srli(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	shamt := (instruction >> 20) & 0b11111
...
// Loads
func (c *CPU) lb(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20
...
func (c *CPU) lbu(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20

	ptr := uint32(c.X[rs1] + uint32(imm))
	c.X[rd] = uint32(c.bus.Read8(ptr))
}
...
func (c *CPU) lhu(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20

	ptr := uint32(c.X[rs1] + uint32(imm))
	c.X[rd] = uint32(c.bus.Read16(ptr))
}

func (c *CPU) lw(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	imm := int32(instruction) >> 20

	ptr := uint32(int32(c.X[rs1]) + int32(imm))
	c.X[rd] = c.bus.Read32(ptr)
}
...
func (c *CPU) sra(instruction uint32) {
	rd := (instruction >> 7) & 0b11111
	rs1 := (instruction >> 15) & 0b11111
	rs2 := (instruction >> 20) & 0b11111
	c.X[rd] = uint32(int32(c.X[rs1]) >> (c.X[rs2] & 0b11111))
}
